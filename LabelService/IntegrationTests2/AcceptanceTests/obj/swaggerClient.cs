...
namespace AcceptanceTests
{
    ...
    public partial class LabellingServer 
    {
        private string _baseUrl = "http://localhost:58765";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public LabellingServer(System.Net.Http.HttpClient httpClient)
        {
        ...
        public System.Threading.Tasks.Task<FileResponse> DeleteLabelAsync(string identcode)
        {
            return DeleteLabelAsync(identcode, System.Threading.CancellationToken.None);
        }
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<FileResponse> GetLabelAsync(string identcode)
        {
            return GetLabelAsync(identcode, System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<FileResponse> GetLabelAsync(string identcode, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/Label/label/{identcode}");
            urlBuilder_.Replace("{identcode}", System.Uri.EscapeDataString(ConvertToString(identcode, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<FileResponse> CreateLabelAsync(LabelDTO label)
        {
            return CreateLabelAsync(label, System.Threading.CancellationToken.None);
        }
    ...
    public partial class LabelDTO : BaseLabelOfAddressDTOAndFeaturesDTO
    {
        ...
        [System.ComponentModel.DataAnnotations.Required]
        public AddressDTO Receiver { get; set; } = new AddressDTO();
    ...
    public partial class AddressDTO 
    {
        ...
        [Newtonsoft.Json.JsonProperty("homeNo", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
    ...
    {
        [Newtonsoft.Json.JsonProperty("deliveryIns", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.0.22.0 (Newtonsoft.Json v11.0.0.0)")]
    public abstract partial class BaseLabelOfAddressDTOAndFeaturesDTO 
    {
